...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "gwttrial" because\n';
  ...
  $wnd.__gwt_activeModules['gwttrial'] = {
    'moduleName' : 'gwttrial',
    'bindings' : function() {
      return {};
    }
 ...
 * "/gwttrial.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['gwttrial'].superdevmode = true;

  var expectedSuffix = '/gwttrial.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + gwttrial + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:gwttrial';
  var devModeSessionKey = '__gwtDevModeSession:gwttrial';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':59433';
  ...
  $wnd.__gwt_activeModules['gwttrial'].canRedirect = true;
  $wnd.__gwt_activeModules['gwttrial'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/gwttrial?user.agent=' + ua + '&_callback=' + callback;
